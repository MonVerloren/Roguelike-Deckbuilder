...
class GameSimV1:
    ...
    def apply_effect(self, card, is_player, is_x2=False):
        # VERSION 1: Pot cộng thẳng vào tổng giá trị, tác động lên mọi chỉ số
        val = card.value * (2 if is_x2 else 1) + self.clash_pot 
...
def run_sim_v1(runs=10000):
    ...
    print(f"\n--- PHIÊN BẢN 1: TÍCH TỤ TÁC ĐỘNG MỌI CHỈ SỐ ({runs} trận) ---")
